...
# または ZIP をダウンロード：Code → Download ZIP → 解凍 → kiro-proxy フォルダを開く
...
これは個人 fork です。基盤 gateway が役立つ場合は、オリジナルプロジェクト [Jwadow/kiro-gateway](https://github.com/Jwadow/kiro-gateway) のサポートをご検討ください。
